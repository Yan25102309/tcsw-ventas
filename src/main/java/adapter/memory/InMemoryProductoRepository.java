...
/**
 * Adaptador de infraestructura en memoria que implementa el puerto ProductoRepository. Proporciona acceso concurrente y seguro mediante ConcurrentHashMap.
 */
public class InMemoryProductoRepository implements ProductoRepository { 
    ...
    public Producto guardar(Producto producto) { 
        if (producto == null) { 
            throw new IllegalArgumentException("El producto a guardar no puede ser nulo"); 
        }
